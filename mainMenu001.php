         ...
         <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    <a class="waves-effect waves-dark" href="mainMenu001.php"><!--FIXME: CHANGE 4(THE MAIN MENU PHP REDIRECTION)-->
...
<script>
    ...
    popupOverlay.addEventListener('click', () => {
      ...
      loginForm.classList.remove('active');
              ...
              <li class="nav-level"><span style="color: white;">---</span> Extras</li>
             <!-- FIXME: CHANGE 3 (THE IMAGE GENARATOR AND THE SELECTIONS)
<li class="treeview">
...
<li class="treeview">
    <a class="waves-effect waves-dark" href="#!">
        <i class="fa fa-question-circle"></i><span> Lists</span><i class="icon-arrow-down"></i>
    </a>
    <ul class="treeview-menu">
        <--TEXT EDITORS START -->
        <!--
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <label>Enable list in about</label>     
                            <input type="checkbox" style="margin-top:5px;"><br>
                            <label>Enable list in services</label>  
                            <input type="checkbox" style="margin-top:1px;"><br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">       
                            ...
                            <button class="button2" 
                                    style="border-color: transparent; color: white; background-color: #ba181b; transition: background-color 0.3s;" 
                                    onmouseover="this.style.backgroundColor='#a4161a'" 
                                    onmouseout="this.style.backgroundColor='#ba181b'">Discard
                            </button>
                        </div>
...
<!-- </ul>
              ...
              <li class="treeview">
               <a class="waves-effect waves-dark" href="helpPage.php">
                   <i class="fa fa-question-circle"></i><span> Help</span><!--FIXME: CHANGE 8(THE LINK)-->
               </a>                
           </li>
            </ul>
         </section>
      ...
      <div class="content-wrapper">
         <iframe style="border-color: transparent;" id="myIframe" class="fullscreen" src="http://localhost:8001/index.php" height="700px" width="1130px"></iframe>
      </div>
   </div>
