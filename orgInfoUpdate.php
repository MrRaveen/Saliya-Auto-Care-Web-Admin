...
$fax = $_POST['fax'];
$id = "1";
if($orgName != null && $address != null && $mail != null && $weekDays != null && $weekEnd != null && $phone != null && $fax != null){
    $sql = "UPDATE orgInfo SET orgName = ?,address = ?,weekDayOpen = ?,weekEndOpen = ?,phone = ?,mail = ?,fax = ? WHERE id = ?";
    $params = array($orgName,$address,$weekDays,$weekEnd,$phone,$mail,$fax,$id);
...
<div class="login-card">
    ...
    <div class="right-section">
        <div class="text-center mb-4">
            <h3>Text Updated Successfuly</h3>
    </div>
