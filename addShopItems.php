...
.custom-input {
        ...
        .custom-label {
            ...
            margin-bottom:4px;
            margin-top:10px;
            margin-left:4px;       /* Semi-bold font for the label */
        }
/*form end (inputs)*/
.custom-file-upload {
    position: relative;
...
-->
      ...
      <div class="content-wrapper"><br>
        <div class="container">
        <div class="row"><div class="col-md-12"><h4>Add an item</h4></div></div><br>
        <form action="dataInsertBackendProcess1.php" method="post" enctype="multipart/form-data">
        <div class="row">
            <?php 
            $arr1 = array("Item Name","Price","Long Name","Description 1","Description 2");
            $arr2 = array("Brand Name","Address"
            ,"Type","Product Link");
            $arr3 = array("Item_Name","Price","Long_Name","Description_1","Description_2");
            $arr3WordLimit = array(60,0,180,660,200);
            $arr4 = array("Brand_Name","Address"
            ,"Type","Product_Link");
           ...
           for($count4 = 0;$count4<5;$count4++){
            if($arr1[$count4] == "Price" && $arr3[$count4] == "Price"){
                ...
                <div class=\"col-md-6\">
                    ...
                    <input required type=\"number\" min=\"0\" class=\"form-control custom-input\" id=\"inputName\" name='$arr3[$count4]' placeholder=\"$arr1[$count4]\">
                </div>
                "; 
            }else{
                echo "
                <div class=\"col-md-6\">
                    <label for=\"inputName\" class=\"form-label custom-label\">$arr1[$count4]($arr3WordLimit[$count4]/<span id=\"currentNumber-{$arr3[$count4]}\">0</span>)</label>
                    <input required type=\"text\" maxlength = \"$arr3WordLimit[$count4]\" class=\"form-control custom-input\" id=\"inputName-{$arr3[$count4]}\" name='$arr3[$count4]' placeholder=\"$arr1[$count4]\">
                </div>
                <script>
               ...
               let length = currentChar.length;
                ...
                if($count4 != 4){
                    if($arr2[$count4] == "Type" && $arr4[$count4] == "Type"){
                        ...
                        <select class=\"form-control custom-input\" id=\"inputName2\" name='$arr4[$count4]'>
                        ...
                        if($arr2[$count4] == "Product Link" && $arr4[$count4] == "Product_Link"){
                            ...
                            <input required type=\"text\" class=\"form-control custom-input\" id=\"inputName2-{$arr4[$count4]}\" name='$arr4[$count4]' placeholder=\"$arr2[$count4]\">
                        </div>
                         <script>
                   ...
                   let length = currentChar.length;
                     document.getElementById('currentNumber-{$arr4[$count4]}').innerText = length;
                            ...
                            <div class=\"col-md-6\">
                            <label for=\"inputName2\" class=\"form-label custom-label\">$arr2[$count4]($arr4WordLimit[$count4]/<span id=\"currentNumber-{$arr4[$count4]}\">0</span>)</label>
                            <input required type=\"text\" class=\"form-control custom-input\" maxlength = \"$arr4WordLimit[$count4]\" id=\"inputName2-{$arr4[$count4]}\" name='$arr4[$count4]' placeholder=\"$arr2[$count4]\">
                        </div>
                         <script>
                      document.getElementById('inputName2-{$arr4[$count4]}').addEventListener('input', function(event) {
                   let currentChar = document.getElementById('inputName2-{$arr4[$count4]}').value;
            ...
            ?>
            <div class="col-md-6">
    <label for="inputName2" class="form-label custom-label">Image</label>
    <div class="custom-file-upload">
        <input required type="file" accept=".jpg" class="form-control custom-input" id="productImage" name="productImage" placeholder="image">
        <span class="upload-button" id="selectedImageName">Click here to choose File</span>
        <script>
    ...
    if (file) {
        ...
        <div class="row">
            <div class="col-md-12"><button class="nextButton" style="color:white;"> Next
        </button></div>
        </div>
        </form>
      </div>
