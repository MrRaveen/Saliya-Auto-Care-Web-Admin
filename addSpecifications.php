...
<script>
    ...
    <div class="container">
        ...
        <br>
           <div class="row">
             <div class="col-md-12"> <label for="inputName2" class="form-label custom-label">Specifications</label></div>
           </div>
           <div class="row">
                <div class="col-md-12">
                     <div style="display:flex;"><input type="text" class="form-control custom-input" name="specificationName" placeholder="Name"><input name="Spedescription" type="text" class="form-control custom-input" style="margin-left:5px;" placeholder="Description">
                     <button class="custom-btn btn-1" name="specAddBtn" style="margin-left:10px;">Add</button>
                </div>
                </div>
           </div>
           <br>
           <div class="row">
             <div class="col-md-12"> <label for="inputName2" class="form-label custom-label">Delivary Info</label></div>
           </div>
           <div class="row">
                <div class="col-md-12">
                     <div style="display:flex;"><input type="text" class="form-control custom-input" name="deInfoName" placeholder="Name"><input name="deInfoDes" type="text" class="form-control custom-input" style="margin-left:5px;" placeholder="Description">
                     <button class="custom-btn btn-1" name="deliInfoBtn" style="margin-left:10px;">Add</button>
                </div>
                </div>
           </div>
           <br>
           <div class="row">
             <div class="col-md-12"> <label for="inputName2" class="form-label custom-label">Additional Info</label></div>
           </div>
           <div class="row">
                <div class="col-md-12">
                     <div style="display:flex;"><input name = "additionalInfo" type="text" class="form-control custom-input" style="margin-left:5px;" placeholder="Description">
...
document.getElementById("input-file_'.$count4IMG.'").addEventListener("change", function() {
    let imgLink2 = URL.createObjectURL(this.files[0]);
    let imgView2 = document.getElementById("img-view_'.$count4IMG.'");
    imgView2.style.backgroundImage = `url(${imgLink2})`;
    imgView2.textContent = "";
    imgView2.style.border = 0;
});
...
document.getElementById("drop-area_'.$count4IMG.'").addEventListener("drop", function(e) {
    e.preventDefault();
    let inputFile2 = document.getElementById("input-file_'.$count4IMG.'");
    inputFile2.files = e.dataTransfer.files;
    let imgLink2 = URL.createObjectURL(inputFile2.files[0]);
    let imgView2 = document.getElementById("img-view_'.$count4IMG.'");
    imgView2.style.backgroundImage = `url(${imgLink2})`;
...
document.getElementById("drop-area2").addEventListener("drop", function(e) {
    ...
    inputFile2.files = e.dataTransfer.files;
    let imgLink2 = URL.createObjectURL(inputFile2.files[0]);
    let imgView2 = document.getElementById("img-view2");
    imgView2.style.backgroundImage = `url(${imgLink2})`;
    imgView2.textContent = "";
    imgView2.style.border = "none";
});
</script>
              </div>
              <!--Flex container end-->
        ...
        <button class="nextButton" name="finishingButton" style="color:white;"> Add & Finish</button>
    </div>
    </div>
</form>
   <!-- Required Jqurey -->
