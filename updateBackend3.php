...
<script>
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <label for="inputName2" class="form-label custom-label">Edit Delivery Info</label>
        </div>
      </div>

      <!-- Editable Delivery Info Section -->
      <div class="row">
        <div class="col-md-12">
          <div class="scrollable">
            <div class="col-md-12">
              <?php 
              $tquery = "SELECT * FROM delivaryInfo WHERE shopItemID = $finishingButton";
              ...
              if ($sperun == false) {
                ...
                while ($row = sqlsrv_fetch_array($sperun, SQLSRV_FETCH_ASSOC)) {
                  $value1 = $row['name'];
                  $value2 = $row['des'];
                  $valueOfDelivaryID = $row['delivaryID'];
                  if ($countrows != $numRows) {
                    echo '
                    <form action="updateBackend3phpcodes.php" method="post">
                    <input hidden type="text" name="finishingbutton" value="'.$finishingButton.'">
                    <div style="display:flex;">
                      <input type="text" class="form-control custom-input" value="' . $value1 . '" name="delivary_cat_name">
                      <input type="text" class="form-control custom-input" style="margin-left:5px;" value="' . $value2 . '" name="delivary_cat_des">
                      <button class="custom-btn btn-1" value="'.$valueOfDelivaryID.'" name="delivary_update_Btn" style="margin-left:10px;">Save</button>
                    </div>
                    <br>
                    </form>';
                  }
      ...
      <!-- Add & Finish Button -->
      <form action="updateBackend4.php" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          <button class="nextButton" value="<?php echo "{$finishingButton}";?>" name="up_backend4_passValue" style="color:white;">Next</button>
        </div>
      </div>
    </div>
  </div>
